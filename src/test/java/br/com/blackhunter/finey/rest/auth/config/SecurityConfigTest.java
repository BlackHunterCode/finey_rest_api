package br.com.blackhunter.finey.rest.auth.config;
...
public class SecurityConfigTest {
    ...
    void accessProtectedEndpoints_WithoutAuthentication_ShouldDenyAccess() throws Exception {
        ...
        // Incluindo os headers necessários para passar pela validação do ClientValidationFilter
        mockMvc.perform(get("/v1/api/user-profile")
                .contentType(MediaType.APPLICATION_JSON)
                .header("X-Device-ID", "test-device-id")
                .header("X-APP-Signature", "test-app-signature"))
