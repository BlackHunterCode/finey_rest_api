...
package br.com.blackhunter.hunter_wallet.rest_api.finance.transaction.mapper;
...
public interface TransactionMapper {
    ...
    @Mapping(
            target = "status",
            expression = "java(payload.isApproved() ? br.com.blackhunter.hunter_wallet.rest_api.finance.transaction.enums.TransactionStatus.POSTED : br.com.blackhunter.hunter_wallet.rest_api.finance.transaction.enums.TransactionStatus.PENDING)"
    )
