...
package br.com.blackhunter.finey.rest.useraccount.mapper;
...
public interface UserProfileMapper {
    ...
    @Mapping(
            target = "age",
            expression = "java((long) java.time.Period.between(entity.getBirthDate(), java.time.LocalDate.now()).getYears())"
    )
